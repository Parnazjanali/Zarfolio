...
const PluginPurchasePage = lazy(() => import('./pages/PluginPurchasePage.jsx'));
const MyPluginsPage = lazy(() => import('./pages/MyPluginsPage.jsx'));
const PluginInvoicesPage = lazy(() => import('./pages/PluginInvoicesPage.jsx'));
// +++ پایان بخش افزونه +++
